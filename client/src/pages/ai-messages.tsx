        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle className="flex items-center space-x-3">
              ...
              <span>AI Message Generator Instructions</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div className="flex items-start space-x-2">
              ...
              <span>Select message type: WhatsApp (200 chars) or SMS (160 chars)</span>
            </div>
            <div className="flex items-start space-x-2">
              ...
              <span>Enter your promotional campaign idea with details</span>
            </div>
            <div className="flex items-start space-x-2">
              ...
              <span>Generate compliant message and copy to Interakt for sending</span>
            </div>
          </CardContent>
        </Card>
      </main>
